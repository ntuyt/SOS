...
def main():
    ...
    model = alexnetgru6view.alexnet(pretrained = True,)
    ...
    train_loader = torch.utils.data.DataLoader(
        MVDataSet("", "trainmodel40.txt", num_segments=0,
                   new_length=1,
                   modality="RGB",
                   image_tmpl="_{:03d}.jpg",
    ...
    val_loader = torch.utils.data.DataLoader(
        MVDataSet("", "testmodel40.txt", num_segments=0,
                   new_length=1,
                   modality="RGB",
                   image_tmpl="_{:03d}.jpg",
                   random_shift=False,
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        input_var = input_var.view((-1,3)+inputsz[-2:])

        #input_var2 = torch.autograd.Variable(input2).cuda()
        #input_var2 = input_var2.view((-1,3)+inputsz[-2:])
        #print(input_var2[1] - input_var[1])
